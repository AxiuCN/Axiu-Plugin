...
export const helpList = [
  ...
  },
  {
    group: '抽卡记录',
    list: [
      { title: '#更新抽卡记录', desc: '米游社官方接口增量更新（近6个月）' },
  ...
  },
  {
    group: '原神终局挑战',
    list: [
      { title: '#深渊', desc: '深境螺旋当期战绩' },
      { title: '#剧诗', desc: '幻想真境剧诗当期战绩' },
      { title: '#危战 / #危战多', desc: '幽境危战·单人 / 多人战绩' },
      { title: '#深渊排名 等', desc: '查看对应玩法群排行' },
    ]
  },
  {
    group: '星铁终局挑战',
    list: [
      { title: '*末日 / *虚构', desc: '末日幻影 / 虚构叙事战绩' },
      { title: '*忘却 / *仲裁', desc: '忘却之庭 / 异相仲裁战绩' },
      { title: '*末日排名 等', desc: '查看对应玩法群排行' },
    ]
  },
  {
    group: '代发言',
